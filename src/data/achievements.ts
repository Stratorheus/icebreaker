...
export const ACHIEVEMENT_POOL: Achievement[] = [
  ...
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "slash-timing", count: 50 },
    reward: 75,
    icon: "swords",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "find-symbol", count: 30 },
    reward: 75,
    icon: "search",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "cipher-crack", count: 25 },
    reward: 75,
    icon: "scroll",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "mine-sweep", count: 40 },
    reward: 75,
    icon: "bomb",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "defrag", count: 30 },
    reward: 75,
    icon: "hard-drive",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "network-trace", count: 30 },
    reward: 75,
    icon: "network",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "signal-echo", count: 30 },
    reward: 75,
    icon: "radio",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "checksum-verify", count: 40 },
    reward: 75,
    icon: "calculator",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "port-scan", count: 30 },
    reward: 75,
    icon: "plug",
    category: "cumulative",
  },
  {
    ...
    condition: { type: "minigame-total-wins", minigame: "subnet-scan", count: 25 },
    reward: 75,
    icon: "network",
    category: "cumulative",
  },
