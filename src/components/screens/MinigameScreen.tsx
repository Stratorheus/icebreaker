...
function buildMetaPowerUps(
  ...
  switch (type) {
    ...
    case "defrag":
      // mine-radar → minigame-specific (highlights rows/cols containing mines for a fraction of timer)
    ...
    case "port-scan":
      ...
      // port-logger → hint (show list of open port numbers during select phase)
